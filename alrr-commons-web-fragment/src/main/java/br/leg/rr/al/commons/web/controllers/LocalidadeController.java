...
@Named
@ViewScoped
public class LocalidadeController extends DialogCrudViewController<Municipio, Integer> {
	...
	/**
	 * @param filtro
	 *            das UFs selecionadas para pesquisar municipio.
	 */
	...
	/**
	 * @param valor
	 *            do filtro 'nome' da pesquisa municipio.
	 */
