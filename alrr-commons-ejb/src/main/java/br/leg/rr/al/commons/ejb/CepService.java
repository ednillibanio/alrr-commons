...
import br.leg.rr.al.commons.jpa.Cep_;
...
@Named
@Stateless
public class CepService extends BaseJPADaoStatus<Cep, Long> implements CepLocal {
	...
	private void formatarCep(Cep cep) {
		...
		String loc = WordUtils.capitalizeFully(cep.getLocalidade());
		cep.setBairro(bairro);
		cep.setLocalidade(loc);
