...
public class StringManager {
	...
	/**
	 * Get the StringManager for a particular package. If a manager for a package already exists, it
	 * will be reused, else a new StringManager will be created and returned.
	 * 
	 * @param packageName
	 *            The package name
	 */
